...
int main()
{
    ...
    while(t--){
        ...
        ll pos=-1;
        for(ll i=1;i<=n;i++){
            if(i!=maxi && i!=maxj && i!=2){pos=i;break;}
        }
        cout<<"?"<<" ";
        cout<<pos<<" "<<2<<" "<<maxi<<endl;
        cin>>k1;

        cout<<"?"<<" ";
        cout<<pos<<" "<<2<<" "<<maxj<<endl;
        cin>>k3;

        ll maxmm=max({k1,k2,k3});
        if(k1==maxmm && k1==k2){cout<<"!"<<" "<<2<<" "<<maxi<<endl;}
        else if(k1==maxmm && k1==k3){cout<<"!"<<" "<<2<<" "<<maxj<<endl;}
        else if(k2==maxmm && k2==k3){cout<<"!"<<" "<<2<<" "<<maxj<<endl;}
        else if(k2==maxmm && k2==k1){cout<<"!"<<" "<<2<<" "<<maxi<<endl;}
        else if(k3==maxmm && k3==k1){cout<<"!"<<" "<<maxi<<" "<<maxj<<endl;}
        else cout<<"!"<<" "<<maxi<<" "<<maxj<<endl;
