...
int main()
{
    ...
    while (t--)
    {
        ...
        while (r < n)
        {
            ...
            while (x > 1)
            {
                if (smallest_factor[x] != smallest_factor[x / smallest_factor[x]])
                {
                    freq[smallest_factor[x]]++;
                    if (freq[smallest_factor[x]] == 1)
                        uniquepr++;
                    if (freq[smallest_factor[x]] == r - l + 1)
                    {
                        f = 1;
                    }
                }
            ...
            while (uniquepr > k && l < r)
            {
                ...
                while (x > 1)
                {
                    ...
                    {
                        freq[smallest_factor[x]]--;
                        if (freq[smallest_factor[x]] == 0)
                            uniquepr--;

                        if (freq[smallest_factor[x]] == r - l)
                        {
                            f = 1;
                        }
                    }
