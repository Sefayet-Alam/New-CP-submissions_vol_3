    ...
    while(t--){
        ...
        for(ll i=0;i<q;i++){
            ...
            if(op==1){
                ...
                if((pos==ms.begin() && *pos>x) || ms.size()==0){
                    cout<<-1<<nn;
                    continue;
                }
                if(pos==ms.end() || *pos>x) pos--;
                ll k=1;
                while(pos!=ms.begin() && k<y){
                    pos--;
                    k++;
                }
                if( k==y && *pos<=x) cout<<*pos<<nn;
                else cout<<-1<<nn;
            }
            else{
                cin>>x>>y;
                ...
                if(pos==ms.end() || ms.size()==0){
                    cout<<-1<<nn;
                    continue;
                }

                ll k=1;
                while(pos!=ms.end() && k<y){
                    pos++;
                    k++;
                }
                if(pos!=ms.end() && k==y && *pos>=x) cout<<*pos<<nn;
                else cout<<-1<<nn;
